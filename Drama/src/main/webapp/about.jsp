						...
						<div class="col-md-6 col-md-push-6">
							<div class="desc">
								...
								<p>Quos quia provident consequuntur culpa facere ratione
									maxime commodi voluptates id repellat velit eaque aspernatur
									expedita. Possimus itaque adipisci rem dolorem nesciunt
									perferendis quae amet deserunt eum labore quidem minima.</p>
							</div>
							<div class="desc">
				...
				<div class="row">
					<div class="col-md-4 col-sm-4 animate-box"
						...
						<div class="fh5co-staff">
							...
							<p>Quos quia provident consequuntur culpa facere ratione
								maxime commodi voluptates id repellat velit eaque aspernatur
								expedita. Possimus itaque adipisci.</p>
		...
		<footer id="fh5co-footer" role="contentinfo">
			<div class="container">
				<div class="row row-pb-md">
					...
					<div
						class="col-md-4 col-sm-12 col-xs-12 fh5co-widget col-md-push-1">
