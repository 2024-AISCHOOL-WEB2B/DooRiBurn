		...
		<a href="javascript:void(0)" class="closebtn" onclick="closeNav()" style="color:#545454;">&times;</a>
			...
			<div class="menu-section">
				...
				<div class="menu-itemss">
					<a href="update.jsp?from=/Drama/contestPost.jsp">회원정보 수정</a> 
			...
			<%} else { %>
				<div class="menu-section">
					<h2>마이 페이지</h2>
					<div class="menu-itemss">
						<a href="login.jsp?from=/Drama/contestPost.jsp">로그인</a> 
						<a href="join.jsp?from=/Drama/contestPost.jsp">회원가입</a>  
					</div>
				</div>
			<%}%> 
		</div>
