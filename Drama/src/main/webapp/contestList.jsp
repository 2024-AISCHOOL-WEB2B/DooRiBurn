		...
		<a href="javascript:void(0)" class="closebtn" onclick="closeNav()" style="color:#545454;">&times;</a>
			...
			<div class="menu-section">
				...
				<div class="menu-itemss">
					<a href="update.jsp?from=/Drama/contestList.jsp">회원정보 수정</a> 
			...
			<%} else { %>
				<div class="menu-section">
					<h2>마이 페이지</h2>
					<div class="menu-itemss">
						<a href="login.jsp?from=/Drama/contestList.jsp">로그인</a> 
						<a href="join.jsp?from=/Drama/contestList.jsp">회원가입</a>  
					</div>
				</div>
			<%}%> 
		</div>
	...
	<div style="clear: both; text-align: center; margin-top: 50px;"> 
 	...
 	<footer id="fh5co-footer" role="contentinfo"> 
 			<div class="button-container">
			   	<div>    
					<%if(info == null) {%>
						<button class="btn" onclick="location.href='login.jsp?from=/Drama/contestList.jsp'">로그인</button>
						<button class="btn" onclick="location.href='join.jsp?from=/Drama/contestList.jsp'">회원가입</button>
					<%} else { %>
						<button class="btn" onclick="location.href='LogoutService?from=/Drama/contestList.jsp'">로그아웃</button>
					<%} %>
